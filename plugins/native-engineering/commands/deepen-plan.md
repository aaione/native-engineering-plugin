...
# 3. native-engineering plugin skills
ls ~/.claude/plugins/cache/*/native-engineering/*/skills/
...
**Important:** Check EVERY source. Don't assume native-engineering is the only plugin. Use skills from ANY installed plugin that's relevant.
...
```
mcp__plugin_native-engineering_context7__resolve-library-id: Find library ID for [framework]
mcp__plugin_native-engineering_context7__query-docs: Query documentation for specific patterns
```
...
# 3. native-engineering plugin agents (all subdirectories)
find ~/.claude/plugins/cache/*/native-engineering/*/agents -name "*.md" 2>/dev/null
...
- native-engineering plugin (but SKIP workflow/ agents - only use review/, research/, design/, docs/)
- ALL other installed plugins (agent-sdk-dev, frontend-design, etc.)
- Any local plugins

**For native-engineering plugin specifically:**
